...
urlpatterns = [
    ...
    path('api/v1/admin/', include([
        ...
        path('payments/', include('apps.subscriptions.payment_admin_urls')),
    ...
    path('api/v1/public/', include([
        ...
        path('payments/', include('apps.subscriptions.payment_public_urls')),
        path('payment-methods/', include('apps.subscriptions.payment_method_public_urls')),
